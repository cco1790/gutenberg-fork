...
export function MediaPlaceholder( {
	...
	const [ isOpen1,setOpen1 ] = useState(2);
	const openModal = () => setOpen1(1);
	const closeModal = () => setOpen1(2);

	 const ImageModal = () => {
		return (
			<>
				{ isOpen1==1 && (
					<Modal  size="fill"   title="select image" onRequestClose={ closeModal }>
						<div>   server image  </div>
